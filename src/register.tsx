...
export default function Register() {
    ...
    const { error, mutate, isLoading } = useRegister()
    ...
    return (
        ...
        <h1 className="font-black text-3xl">Previet: Register</h1>
        <div className="py-10">
            <form onSubmit={submit}>
                <div className="flex flex-col space-y-5 w-96 text-black">
                    <div className="flex flex-col">
                        <label htmlFor="fullname" className="text-white">Fullname</label>
                        <input required type="text" name="fullname" id="fullname" className="border border-gray-300 rounded-md p-2" />
                    </div>
                    <div className="flex flex-col">
                    ...
                    <button disabled={isLoading} type="submit" className="bg-violet-500 text-white rounded-md p-2">Register</button>
                </div>
